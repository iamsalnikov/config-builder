...
class EnvironmentTest extends TestCase
{
    ...
    {
        return [
            ['pr' => '',   'param' => 'test.param1', 'envParam' => 'TEST_PARAM1',    'inEnv' => false, 'value' => ''],
            ['pr' => '',   'param' => 'test.param2', 'envParam' => 'TEST_PARAM2',    'inEnv' => true,  'value' => 'good1'],
            ['pr' => '',   'param' => 'testParam3',  'envParam' => 'TEST_PARAM3',    'inEnv' => false, 'value' => ''],
            ['pr' => '',   'param' => 'testParam4',  'envParam' => 'TEST_PARAM4',    'inEnv' => true,  'value' => 'good2'],
            ['pr' => '',   'param' => '',           'envParam' => '',              'inEnv' => false, 'value' => ''],
            ['pr' => '',   'param' => '',           'envParam' => '',              'inEnv' => true,  'value' => ''],
            ['pr' => 'TT_', 'param' => 'test.param5', 'envParam' => 'TT_TEST_PARAM5', 'inEnv' => false, 'value' => ''],
            ['pr' => 'TT_', 'param' => 'test.param6', 'envParam' => 'TT_TEST_PARAM6', 'inEnv' => true,  'value' => 'good3'],
            ['pr' => 'TT_', 'param' => 'testParam7',  'envParam' => 'TT_TEST_PARAM7', 'inEnv' => false, 'value' => ''],
            ['pr' => 'TT_', 'param' => 'testParam8',  'envParam' => 'TT_TEST_PARAM8', 'inEnv' => true,  'value' => 'good4'],
            ['pr' => 'TT_', 'param' => '',           'envParam' => '',              'inEnv' => false, 'value' => ''],
            ['pr' => 'TT_', 'param' => '',           'envParam' => '',              'inEnv' => true,  'value' => ''],
        ];
    }
}